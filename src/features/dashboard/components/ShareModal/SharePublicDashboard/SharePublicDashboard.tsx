...
import { useGetConfigQuery, useSaveConfigMutation } from 'features/dashboard/api/publicDashboardApi';
import { AcknowledgeCheckboxes } from 'features/dashboard/components/ShareModal/SharePublicDashboard/AcknowledgeCheckboxes';
import { Configuration } from 'features/dashboard/components/ShareModal/SharePublicDashboard/Configuration';
import { Description } from 'features/dashboard/components/ShareModal/SharePublicDashboard/Description';
import {
  Acknowledgements,
...
import { ShareModalTabProps } from 'features/dashboard/components/ShareModal/types';
import { isOrgAdmin } from 'features/plugins/admin/permissions';
