import { CombinedRule, Rule, RuleIdentifier, RuleWithLocation } from 'types/unified-alerting';
import { Annotations, Labels, RulerRuleDTO } from 'types/unified-alerting-dto';
