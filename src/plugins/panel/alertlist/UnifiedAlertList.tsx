...
import { fetchAllPromRulesAction } from 'features/alerting/unified/state/actions';
import { labelsMatchMatchers, parseMatchers } from 'features/alerting/unified/utils/alertmanager';
...
import { flattenRules, getFirstActiveAt } from 'features/alerting/unified/utils/rules';
import { getDashboardSrv } from 'features/dashboard/services/DashboardSrv';
import { DashboardModel } from 'features/dashboard/state';
import { useDispatch, AccessControlAction } from 'types';
import { PromRuleWithLocation } from 'types/unified-alerting';
